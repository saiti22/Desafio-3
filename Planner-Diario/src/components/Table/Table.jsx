...
//         console.log('delete');
//         console.log(index);
//         ShowModal('deletar', tarefas[index], index);
//     },[tarefas]);
...
//         console.log('edit');
//         ShowModal('editar', tarefas[index]);
//     }, [tarefas]);
...
//                     <div className="tBody-cell cell-tarefa">{tarefa}</div>
...
//                 <input type="text" placeholder='Nova Tarefa...' id='task-input' onKeyUp={(event) =>  {
//                     if (event.key ==='Enter') {
...
//                 <label htmlFor="task-input"><img src="./plus.svg" alt="plus" /></label>
//             </div>
